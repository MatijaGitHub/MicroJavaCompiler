...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(NoMulOperations NoMulOperations) { visit(); }
    public void visit(MulOperationsC MulOperationsC) { visit(); }
    public void visit(Term Term) { visit(); }
    public void visit(NoAddopTerms NoAddopTerms) { visit(); }
    public void visit(AddopTermsC AddopTermsC) { visit(); }
    ...
    public void visit(NoTypeIdentList NoTypeIdentList) { visit(); }
    public void visit(TypeIdentListC TypeIdentListC) { visit(); }
    ...
    public void visit(NoConstListVar NoConstListVar) { visit(); }
    public void visit(VarListC VarListC) { visit(); }
    ...
    public void visit(ConstListC ConstListC) { visit(); }
