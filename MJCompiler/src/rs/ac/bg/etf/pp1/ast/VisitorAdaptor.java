...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(SubOperation SubOperation) { visit(); }
    public void visit(AddOperation AddOperation) { visit(); }
    public void visit(LoweqOp LoweqOp) { visit(); }
    public void visit(LowOp LowOp) { visit(); }
    public void visit(GrtEqOp GrtEqOp) { visit(); }
    ...
    public void visit(DesignatorFactorBool DesignatorFactorBool) { visit(); }
    public void visit(DesignatorFactorChar DesignatorFactorChar) { visit(); }
    public void visit(DesignatorFactorNumber DesignatorFactorNumber) { visit(); }
    public void visit(DesignatorFactorAct DesignatorFactorAct) { visit(); }
    public void visit(DesignatorFactor DesignatorFactor) { visit(); }
    public void visit(EndMulOp EndMulOp) { visit(); }
    public void visit(BeginMulOp BeginMulOp) { visit(); }
    public void visit(Term Term) { visit(); }
    public void visit(EndAddopTerm EndAddopTerm) { visit(); }
    public void visit(NotEndAddopTerm NotEndAddopTerm) { visit(); }
    public void visit(MinusExpr MinusExpr) { visit(); }
    public void visit(PlusExpr PlusExpr) { visit(); }
    public void visit(TwoCondFact TwoCondFact) { visit(); }
    public void visit(OneCondFact OneCondFact) { visit(); }
    public void visit(NoAndTerms NoAndTerms) { visit(); }
    public void visit(AndTermsC AndTermsC) { visit(); }
    ...
    public void visit(DesignatorListC DesignatorListC) { visit(); }
    ...
    public void visit(AssignOpExprBase AssignOpExprBase) { visit(); }
    public void visit(DesignatorStatementMul DesignatorStatementMul) { visit(); }
    public void visit(DesignatorStatementOne DesignatorStatementOne) { visit(); }
    public void visit(NoNumberConst NoNumberConst) { visit(); }
    public void visit(NumberConstC NumberConstC) { visit(); }
    public void visit(EndElseStatement EndElseStatement) { visit(); }
    public void visit(EndIfStatement EndIfStatement) { visit(); }
    public void visit(BeginElseStatement BeginElseStatement) { visit(); }
    public void visit(NoElseStatement NoElseStatement) { visit(); }
    public void visit(ElseStatementC ElseStatementC) { visit(); }
    public void visit(NoExpression NoExpression) { visit(); }
    public void visit(ExpressionC ExpressionC) { visit(); }
    public void visit(Foreach Foreach) { visit(); }
    public void visit(While While) { visit(); }
    public void visit(IfStart IfStart) { visit(); }
    public void visit(BeginWhile BeginWhile) { visit(); }
    ...
    public void visit(NoConstructorDeclarations NoConstructorDeclarations) { visit(); }
    public void visit(ConstructorDeclarationsC ConstructorDeclarationsC) { visit(); }
    public void visit(NoClassDeclarations NoClassDeclarations) { visit(); }
    public void visit(ClassDeclarationsC ClassDeclarationsC) { visit(); }
    public void visit(NoVarDeclarations NoVarDeclarations) { visit(); }
    public void visit(VarDeclarationsC VarDeclarationsC) { visit(); }
    public void visit(NoExtendsType NoExtendsType) { visit(); }
    public void visit(ExtendsTypeC ExtendsTypeC) { visit(); }
    public void visit(ClassDecl ClassDecl) { visit(); }
    public void visit(NoBrackets NoBrackets) { visit(); }
    public void visit(BracketsC BracketsC) { visit(); }
    public void visit(EndingVarDeclList EndingVarDeclList) { visit(); }
    public void visit(NonEndingVarDeclList NonEndingVarDeclList) { visit(); }
    public void visit(EndingVarDeclListC EndingVarDeclListC) { visit(); }
    public void visit(NonEndingVarDeclListC NonEndingVarDeclListC) { visit(); }
    ...
    public void visit(NonEndingConstDeclListError NonEndingConstDeclListError) { visit(); }
    public void visit(NonEndingConstDeclListC NonEndingConstDeclListC) { visit(); }
    public void visit(EndingConstDeclListError EndingConstDeclListError) { visit(); }
    public void visit(EndingConstDeclListC EndingConstDeclListC) { visit(); }
    public void visit(EndingConstDeclListC1 EndingConstDeclListC1) { visit(); }
    public void visit(NonEndingConstDeclListC1 NonEndingConstDeclListC1) { visit(); }
