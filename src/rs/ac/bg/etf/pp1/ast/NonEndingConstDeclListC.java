...
public class NonEndingConstDeclListC extends NonEndingConstDeclList {

    private String constName;
    private Const Const;

    public NonEndingConstDeclListC (String constName, Const Const) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NonEndingConstDeclListC(\n");
