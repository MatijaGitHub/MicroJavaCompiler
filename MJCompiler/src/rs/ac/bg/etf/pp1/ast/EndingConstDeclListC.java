...
public class EndingConstDeclListC extends EndingConstDeclList {

    private String constName;
    private Const Const;

    public EndingConstDeclListC (String constName, Const Const) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("EndingConstDeclListC(\n");
